---
title: Lets'encrypt - DNS-01チャレンジ
description: この文書は、powerdns/letsencrypt 連携による DNS-01チャレンジの実践の記録。
date: 2024-12-31T00:00:00.0900Z
draft: false
tags:
  - Let'sEncrypt
  - certbot
...
1. pdns → powerdns （以前failしたものが復活??) 時系列的に追跡していないため詳細は不明。

コマンドラインの引数が "pdns" → "powerdns” になったので、バッチファイル書いている人は書き換える。
...
2. クレデンシャルで entrypoint が api-url になる
